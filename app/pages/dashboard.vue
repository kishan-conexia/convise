  ...
  <div class="min-h-screen relative overflow-hidden">
    ...
    <div v-else class="relative min-h-screen">
      ...
      >
        ...
        />
        <div
          class="absolute inset-0 bg-grid-slate-100 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.6))] bg-[size:75px_75px]"
        />

        <!-- Floating Elements (smaller for drawer) -->
        <div
          class="absolute top-16 left-4 w-32 h-32 bg-gradient-to-r from-emerald-400/30 to-blue-500/30 rounded-full mix-blend-multiply filter blur-xl animate-blob"
        />
        <div
          class="absolute top-32 right-4 w-28 h-28 bg-gradient-to-r from-purple-400/30 to-pink-500/30 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"
        />

        <div
          class="relative h-full bg-white/80 backdrop-blur-lg border-r border-gray-200/50 shadow-2xl flex flex-col overflow-y-auto"
        >
          ...
          <div class="px-6 pb-6 border-b border-gray-200/50">
            <div class="relative">
              ...
              />
              <div
                class="relative bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-gray-200/50"
              >
                <div class="flex items-center space-x-4 mb-3">
                  <div class="relative">
                    <div
                      class="w-12 h-12 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 flex items-center justify-center shadow-lg"
                    >
                  ...
                  <div class="flex-1">
                    ...
                    <p class="text-sm text-gray-600">
                      {{ userProfileStore.empCode || user?.email }}
                    </p>
                  </div>
                </div>
                <div
                  class="inline-flex items-center px-3 py-1 bg-gradient-to-r from-emerald-500/10 to-blue-600/10 rounded-full text-xs"
                >
                  <div
          ...
          <div class="flex-1 py-6 px-4">
            <nav class="space-y-3">
              ...
              <div class="group">
                <div class="relative">
                  <div
                    class="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-blue-600 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                  />
                  <button
              ...
              >
                <div class="relative">
                  <div
                    class="absolute -inset-0.5 bg-gradient-to-r from-orange-500 to-red-600 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                  />
                  <button
                    class="relative w-full flex items-center space-x-3 px-4 py-3 bg-white/60 backdrop-blur-sm hover:bg-white/80 rounded-xl transition-all duration-200 border border-gray-200/50 hover:border-gray-300/50"
              ...
              <div v-if="userProfileStore.showManagerTools" class="pt-4">
                ...
                <div class="group mb-3">
                  <div class="relative">
                    <div
                      class="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                    />
                    <button
                      class="relative w-full flex items-center space-x-3 px-4 py-3 bg-white/60 backdrop-blur-sm hover:bg-white/80 rounded-xl transition-all duration-200 border border-gray-200/50 hover:border-gray-300/50"
                ...
                <div class="group mb-3">
                  <div class="relative">
                    <div
                      class="absolute -inset-0.5 bg-gradient-to-r from-violet-500 to-purple-600 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                    />
                    <button
                      class="relative w-full flex items-center space-x-3 px-4 py-3 bg-white/60 backdrop-blur-sm hover:bg-white/80 rounded-xl transition-all duration-200 border border-gray-200/50 hover:border-gray-300/50"
          ...
          <div class="p-6 border-t border-gray-200/50">
            <div class="group">
              <div class="relative">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-red-500 to-red-600 rounded-xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                />
                <button
      ...
      <header
        class="relative bg-white/90 backdrop-blur-xl border-b border-gray-200/50 shadow-lg"
      >
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between items-center py-4">
            ...
            <div class="flex items-center">
              <!-- Mobile Menu Button -->
              <button
                class="lg:hidden p-2 text-gray-600 hover:text-gray-900 hover:bg-gray-100/80 rounded-xl transition-all duration-200 mr-4"
              ...
              <div class="flex items-center">
                <div class="relative mr-4">
                  <div
                    class="absolute inset-0 bg-gradient-to-r from-emerald-500 to-blue-600 rounded-xl blur-sm opacity-75"
                  />
                  <div
                    class="relative bg-gradient-to-r from-emerald-500 to-blue-600 p-3 rounded-xl shadow-lg"
                  >
                    <UIcon
            ...
            <div class="hidden lg:flex items-center space-x-6">
              ...
              <!-- Improved Quick Sign Out Button (AppHeader.vue Style) -->
              <div class="border-l border-gray-200 pl-4">
                <UButton
                  variant="soft"
                  color="red"
                  size="sm"
                  class="bg-red-50/80 hover:bg-red-100/90 border border-red-200/60 text-red-700 hover:text-red-800 backdrop-blur-sm transition-all duration-200 shadow-sm hover:shadow-md font-medium"
                  @click="handleSignOut"
                >
                  <UIcon
                    name="i-heroicons-arrow-right-on-rectangle"
            ...
            <div class="lg:hidden">
              <UPopover :popper="{ placement: 'bottom-end' }" mode="click">
                <div
                  class="w-10 h-10 rounded-full bg-gradient-to-r from-emerald-500 to-blue-600 flex items-center justify-center shadow-lg cursor-pointer"
                >
                ...
                <template #panel="{ close }">
                  <div
                    class="w-56 bg-white rounded-xl shadow-2xl border border-gray-200 z-[9999] overflow-hidden"
                  >
                    <!-- Mobile User Info -->
                    <div
                      class="px-4 py-3 bg-gradient-to-r from-emerald-50 to-blue-50 border-b"
                    >
                    ...
                    <div class="py-2">
                      <button
                        class="w-full flex items-center px-4 py-3 text-gray-700 hover:bg-gray-50"
                        @click="
                          () => {
                            close();
                            navigateTo('/profile');
                      ...
                      <button
                        class="w-full flex items-center px-4 py-3 text-red-700 hover:bg-red-50 font-medium"
                        @click="
                          () => {
                            close();
                            handleSignOut();
                      ...
                      >
                        <UIcon
                          name="i-heroicons-arrow-right-on-rectangle"
                          class="h-5 w-5 mr-3 text-red-600"
                        />
                        Sign Out
                      </button>
                    </div>
      ...
      <main class="relative max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <section class="mb-12">
          <div class="relative">
            ...
            >
              <div
                class="bg-gradient-to-r from-emerald-500 via-blue-600 to-purple-700 p-8 text-white"
              >
                <div class="flex items-center justify-between">
                  <div>
                    ...
                    <p class="text-blue-100 text-base md:text-lg mb-4">
                      Ready to manage your day efficiently
                    </p>
                    <div
                      class="inline-flex items-center px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full"
                    >
                      <div
                        class="w-2 h-2 bg-green-400 rounded-full mr-2 animate-pulse"
                      />
                      <span class="text-sm font-medium"
                        >System Status: All Connected</span
                      >
                    </div>
                  </div>
                  <div class="hidden lg:block">
                    <div
                      class="w-32 h-32 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm"
                    >
                      <UIcon
        ...
        <section class="mb-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group cursor-pointer" @click="navigateTo('/profile')">
              <div class="relative">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                />
                <UCard
                ...
                >
                  <div class="text-center">
                    <div
                      class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-emerald-500 to-teal-600 rounded-2xl mb-6"
                    >
                      <UIcon
                        name="i-heroicons-user"
                        class="h-8 w-8 text-white"
            ...
            >
              <div class="relative">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                />
                <UCard
                  class="relative bg-white/80 backdrop-blur-lg border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105 p-6"
                >
                  <div class="text-center">
                    <div
                      class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-orange-500 to-red-600 rounded-2xl mb-6"
                    >
                      <UIcon
                        name="i-heroicons-signal"
                        class="h-8 w-8 text-white"
        ...
        <section v-if="userProfileStore.showManagerTools" class="mb-12">
          <div class="mb-8">
            <h3 class="text-2xl font-bold text-gray-900 mb-2">
              Management Tools
            </h3>
            <p class="text-gray-600">
              Administrative functions for team leaders
            </p>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div class="relative">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                />
                <UCard
                  class="relative bg-white/80 backdrop-blur-lg border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105 p-6"
                >
                  <div class="text-center">
                    <div
                      class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-2xl mb-6"
                    >
                      <UIcon
                        name="i-heroicons-chart-bar"
                        class="h-8 w-8 text-white"
            ...
            <div
              class="group cursor-pointer"
              @click="navigateTo('/team-requests')"
            >
              <div class="relative">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-violet-500 to-purple-600 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                />
                <UCard
                  class="relative bg-white/80 backdrop-blur-lg border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105 p-6"
                >
                  <div class="text-center">
                    <div
                      class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-violet-500 to-purple-600 rounded-2xl mb-6"
                    >
                      <UIcon
                        name="i-heroicons-users"
                        class="h-8 w-8 text-white"
            ...
            >
              <div class="relative">
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl blur opacity-0 group-hover:opacity-100 transition duration-1000 group-hover:duration-200"
                />
                <UCard
                  class="relative bg-white/80 backdrop-blur-lg border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group-hover:scale-105 p-6"
                >
                  <div class="text-center">
                    <div
                      class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-pink-500 to-rose-600 rounded-2xl mb-6"
                    >
                      <UIcon
                        name="i-heroicons-calendar-days"
                        class="h-8 w-8 text-white"
        ...
        <section class="text-center">
          <div class="relative">
            ...
            />
            <UCard
              class="relative bg-white/80 backdrop-blur-lg border-0 shadow-xl p-8"
            >
  ...
  meta: [
    {
      name: "description",
      content:
        "Your personalized HR dashboard with attendance tracking, team management, and more.",
    },
  ],
});
</script>
